...
function ExploreCourses() {
  ...
  return (
    <div className='w-[100vw] min-h-[50vh] flex flex-col lg:flex-row items-center justify-center gap-5 px-[30px] py-[60px]'>

    {/* left side */}
        <div className='w-full lg:w-[350px] flex flex-col items-start justify-center gap-4 md:px-[40px] px-[20px]'>

            <span className='text-[35px] font-semibold mt-2 lg:mt-10'>Explore</span>
            <span className='text-[35px] font-semibold'>Our Courses</span>

            <p className='text-[17px]'>
            Discover courses designed to build real skills, not just fill pages.
            Whether you’re starting from zero or leveling up, each module is structured
            to teach practical concepts you can apply immediately. Browse through the
            catalog, pick your path, and start learning with clear goals and
            hands-on content.
            </p>

            <button className='flex items-center gap-2 px-[20px] py-[10px] border-2 bg-black border-white text-white rounded-[10px] text-[18px] font-light mt-[30px] cursor-pointer' onClick={()=>navigate("/allcourses")}>
            Explore Courses
