    ...
    return(
        <div className='min-h-screen bg-gray-100 px-4 py-10 flex items-center justify-center'>
            <div className='bg-white shadow-lg rounded-2xl p-8 max-w-xl w-full relative'>
                <FaHome className='absolute top-[8%] left-[5%] w-[22px] h-[22px] cursor-pointer' onClick={()=>navigate("/")} />
                ...
                <div className='mt-6 space-y-4'>
                    <div className='text-large flex items-center justify-start gap-1'>
...
export default Profile   // typo OR missing export
