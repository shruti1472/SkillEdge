...
function ViewLecture() {
  ...
  return (
    <div className='min-h-screen bg-gray-50 p-6 flex flex-col md:flex-row gap-6'>
        ...
        {/* left or top for lecture vedio */}
        <div className='w-full mid:w-2/3 bg-white rounded-2xl shadow-md p-6 border border-gray-200'>
        <div className='mb-6'>
        ...
        {/* right and bottom for list of lecture*/}
        <div className='w-full md:w-1/3 bg-white rounded-2xl shadow-md p-6 border border-gray-200 h-fit'>
          ...
          <div className='flex flex-col gap-3 mb-6'>
            ...
            : (<p className='txt-gray-500'>No Lecture Available</p>)}
          </div>
          ...
          { creatorData && <div className='mt-4 border-t pt-4'>
             ...
             {/* image of educator */}
             <div><img src={creatorData?.photoUrl} className='rounded-full object-cover w-14 h-14' alt=""/></div>

             {/* name and other detail of educator */}
             <div>
